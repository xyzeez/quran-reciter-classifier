...
N_MEL_BANDS = 128  # Number of Mel bands
WINDOW_SIZE_MS = 25  # Window size in milliseconds
STEP_SIZE_MS = 10  # Step size in milliseconds

# Data Augmentation Parameters
PITCH_STEPS = [1.5, -1.5]  # Pitch shift steps
TIME_STRETCH_RATES = [0.9, 1.1]  # Time stretch rates
NOISE_FACTOR = 0.005  # Noise addition factor
VOLUME_ADJUST = 0.8  # Volume adjustment factor
...
BLSTM_SEQUENCE_LENGTH = 32  # Sequence length for BLSTM input
...
# Preprocessing Parameters (Added to replace hardcoded values)
MIN_USABLE_DURATION = 5  # Minimum usable duration in seconds after trimming
DURATION_PERCENTAGE_THRESHOLD = 0.1  # Percentage threshold for short files
